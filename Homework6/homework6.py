...
def train(optimizer, save_path, class_names, num_classes, input_shape, optimizer_name): 
    ...
    bayes_optimisation_tuning(train_loop, input_shape)
    random_search_sklearn_tuning(model, train_images, train_labels, test_images, test_labels)
    random_search_keras_tuning(test_images, train_labels)
...
def main():
    ...
    bayes_optimisation_tuning(train_loop, input_shape)
    random_search_sklearn_tuning(train_images, train_labels, test_images, test_labels)
    random_search_keras_tuning(test_images, train_labels)
